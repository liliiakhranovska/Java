...
import static Board.logic.Piece.PieceName.QUEEN;

public class QueenImpl extends AbstractPiece {

    public QueenImpl(final Environment environment, Color color) {
        super(color, QUEEN, environment);
    }
